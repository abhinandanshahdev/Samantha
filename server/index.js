...
const taskAssociationsRoutes = require('./routes/taskAssociations');
const taskLikesRoutes = require('./routes/taskLikes');
...
app.use('/api', taskAssociationsRoutes);
app.use('/api', taskLikesRoutes);
