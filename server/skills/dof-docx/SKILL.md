---
name: Word Document
description: Create professional Word documents (.docx) with DoF branding, proper formatting, headers, tables, and lists for reports and memos.
triggers: create document, make docx, word document, create report, write memo
